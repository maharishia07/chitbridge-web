...
function cbDefCss(){
  ...
  s.textContent = [
    ...
    '.cbdef-n{margin-inline-start:auto;font-size:11.5px;color:var(--grey);font-variant-numeric:tabular-nums}',
    ...
    '.cbdef-new{margin-inline-start:10px;border:1px solid var(--blue,var(--blue));background:var(--blue,var(--blue));color:#fff;border-radius:9px;padding:4px 11px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit;flex:none}',
