...
const CAP_CATALOGUE = [
  { id:'core', name:'Core — Governance rail', icon:'🛤️', load:'eager', maturity:2, target:3,
    ...
    features:[
      ...
      {n:'Message — a first-class subject, per-copy scoping: INTERNAL (single copy, private to the entity + its workforce) · EXTERNAL (replicated to each participant entity) · DISPUTE (to the roster only — one or more participants)', s:'done'},
