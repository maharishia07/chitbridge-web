...
function _acTierSummary(x){
  ...
  return '<div style="padding:16px">'
    ...
    +'<div style="display:grid;grid-template-columns:1fr 1fr;gap:9px;margin:15px 0">'
      +'<div style="background:#f4f6f8;border:1px solid var(--line);border-radius:11px;padding:11px 12px"><div style="font-size:11px;color:var(--grey);text-transform:uppercase;letter-spacing:.03em">Devices</div><div style="font-size:20px;font-weight:800;margin-top:2px">'+cnt+'</div></div>'
      +'<div style="background:#f4f6f8;border:1px solid var(--line);border-radius:11px;padding:11px 12px"><div style="font-size:11px;color:var(--grey);text-transform:uppercase;letter-spacing:.03em">Health</div><div style="font-size:16px;font-weight:800;margin-top:4px;color:'+hc+'">'+esc(h)+'</div></div>'
    +'</div>'
