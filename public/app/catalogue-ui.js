...
(function (root) {
  ...
  function ensureCss() {
    ...
    s.textContent = [
      ...
      '.cbcat-q{flex:1 1 auto;min-width:0;height:40px;border:1px solid var(--line,#E7E2D8);border-radius:9px;',
      ...
      'border:1px solid var(--line,#E7E2D8);background:#f7f8fa;white-space:nowrap;font-size:var(--fs-2);font-weight:800;',
      ...
      '.cbcat-linetotal{font-size:var(--fs-1);color:#6a707a;font-weight:800}',
      ...
      '.cbcat-stp input{width:52px;height:30px;border:1px solid var(--line,#E7E2D8);border-radius:9px;',
      ...
      '.cbcat-offer{display:block;width:100%;height:28px;border:1px solid var(--blue,#3F66A6);border-radius:6px;',
      ...
      'font-size:var(--fs-2);font-weight:700;color:var(--ink,#0F2E3D);cursor:pointer;font-family:inherit;',
      'white-space:nowrap}',
      ...
      '.cbcat-cnt{font-size:var(--fs-1);color:#6a707a}',
      '.cbcat-all{font-size:var(--fs-1);color:var(--blue,#3F66A6);font-weight:700;cursor:pointer;margin-left:auto}',
      ...
      'background:var(--gold-soft,#F7F1E4);border:1px solid var(--gold-line,#E8D9BC);border-radius:9px;',
      'font-size:var(--fs-2);color:#6b5a36;box-shadow:0 -6px 12px -10px rgba(15,46,61,.45)}',
      ...
      '.cbcat-offhd{font-size:var(--fs-1);font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#2c7a43;margin-bottom:4px}',
      ...
      'border:1px dashed #c3d3e8;border-radius:9px;font-size:12px;font-family:inherit;background:#fff;',
      ...
      '.cbcat-clip{cursor:pointer;border:1px solid var(--line,#E7E2D8);border-radius:9px;padding:3px 8px;',
