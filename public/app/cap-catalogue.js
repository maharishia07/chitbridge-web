...
function catfFillItem(){
  ...
  modal('<div class="mhd"><div class="t">Fill an item — rendered by json-editor (adopted · MIT)</div></div><div class="mbody" style="padding:0"><div style="padding:14px 18px"><div style="font-size:11.5px;color:var(--grey);margin-bottom:10px">This form is generated by the <b>json-editor</b> library straight from <b>our JSON Schema</b> — we wrote no form code. Fill it, then capture the item.</div><div id="cat_je">loading the renderer…</div><div id="cat_je_out" style="margin-top:12px"></div><button class="pri" onclick="catfCaptureItem()" style="margin-top:12px;padding:9px 15px">Capture item ✓</button></div></div>', true);
