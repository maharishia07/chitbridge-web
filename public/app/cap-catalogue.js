...
function _cwMethodBlock(w){
  ...
  return '<div style="margin-bottom:14px">'
    ...
    + '<div style="margin-top:6px;font-size:11px;color:#2c5aa0;background:#eef4fc;border:1px solid #cfe0f4;border-radius:7px;padding:5px 9px">'
...
function _catfAppearsTab(f, c, facets){
  ...
  var step = function(n, title, inner){ return '<div style="border:1px solid var(--line);border-radius:11px;background:#fff;padding:11px 13px;margin-top:8px"><div style="font-size:11px;font-weight:800;color:#2c5aa0;letter-spacing:.04em;margin-bottom:8px">' + n + ' · ' + title + '</div>' + inner + '</div>'; };
