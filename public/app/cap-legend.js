...
const CAP_CATALOGUE = [
  ...
  { id:'network', name:'Network — one shopfront, many entities', icon:'🏬', load:'lazy', maturity:2, target:4,
    ...
    govGap:['who may ADD an entity to a network, and must it consent — unanswered, and it decides whether the network tier is safe at scale','no UI to create a network (cb_* writes are 503; membership needs SQL)','no HUMAN live-run of the network storefront page'],
    ...
    features:[
      ...
      {n:'☐ No UI to CREATE a network or place a member — cb_* writes are 503, membership is seeded by SQL', s:'backlog'},
      ...
      {n:'☐ Consent to membership; multi-network entities (network visibility would then need to be per-network)', s:'backlog'},
    ]},
