...
function _tile(k,v){ return '<div style="background:#f4f6f8;border:1px solid var(--line);border-radius:12px;padding:10px 11px;min-width:0"><div style="font-size:11px;color:var(--grey);text-transform:uppercase;letter-spacing:.03em">'+k+'</div><div style="font-size:19px;font-weight:800;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+v+'</div></div>'; }
...
function _addDeviceForm(x,iot){
  ...
  return '<div style="border:1px dashed #c9d2dd;border-radius:9px;padding:12px;margin:10px 0;background:#fbfcfe"><div style="font-weight:700;font-size:12.5px;margin-bottom:2px">Add '+(iot?'device':'endpoint')+'</div>'
