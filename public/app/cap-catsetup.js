...
function catsetBody(k){
  ...
  if (k === 'offers') {
    return catsetCard('Discounts, tiers and deals',
      ...
      + 'still writing.</div>',
      '<a class="composebtn" data-testid="catset-offer-lab" href="offer-lab.html" target="_blank" rel="noopener" title="Design an offer and see exactly what a customer sees — the same engine and cart as the shop" style="text-decoration:none;margin-right:6px">🧪 ' + tx('Offer lab') + '</a>'
