...
function _catfWizard(){
  ...
  return '<div style="flex:1;min-height:0;overflow-y:auto;padding-bottom:var(--scroll-tail);padding:22px 22px var(--scroll-tail)"><div style="max-width:940px"><div style="font-size:19px;font-weight:800">' + tx('🗂️ Set up your catalogue') + '</div><div style="font-size:var(--fs-1);color:var(--grey);margin:4px 0 16px">Currency <b>' + esc(_catfCcy()) + '</b> — from Settings · fill as much as you can, in order; each step is optional.</div>' + bar + body + nav + '</div></div>';
}
