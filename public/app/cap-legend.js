...
const CAP_CATALOGUE = [
  ...
  { id:'catalogue', name:'Catalogue — source-governed distribution', icon:'🏬', load:'lazy', maturity:3, target:4,
    ...
    features:[
      ...
      {n:'⚠️ Vertical-agnostic referenced DISPLAY + per-product units + generic commercials — the gap that HOLDS non-paint rollout (SPEC-adoption-generalize)', s:'backlog'},
